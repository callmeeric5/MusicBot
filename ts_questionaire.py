...
def get_songs(answers):
    ...
    selferr = np.array([selffeel[i] - answers[0] for i in range(numsongs)])
    stageserr = np.array([stages[i] - answers[1] for i in range(numsongs)])
    seriouserr = np.array([seriousness[i] - answers[2] for i in range(numsongs)])
    futureerr = np.array([future[i] - answers[3] for i in range(numsongs)])
    maleerr = np.array([malefeel[i] - answers[4] for i in range(numsongs)])
    togethererr = np.array([together[i] - answers[5] for i in range(numsongs)])
    ...
    res = [title[item] for item in finalok]
